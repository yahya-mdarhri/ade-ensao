...
<?php include("cs.php"); ?>
  ...
  box-shadow: 0 19px 51px 0 rgba(0,0,0,0.16), 0 14px 19px 0 rgba(0,0,0,0.07);">
                                    <ul class="fh5co-social">
                                        ...
                                        <li><a href="https://www.linkedin.com/in/youssef-lbour-694791190/"target="_blank "><i class="icon-linkedin2"></i></a></li>
                                    </ul>
                                </div>
                                <span>président</span>
                                <h3>youssef lbour</h3>
  ...
  box-shadow: 0 19px 51px 0 rgba(0,0,0,0.16), 0 14px 19px 0 rgba(0,0,0,0.07);">
                                    <ul class="fh5co-social">
                                        ...
                                        <li><a href="https://www.linkedin.com/in/hadil-mhamdi-87a606189/"target="_blank "><i class="icon-linkedin2"></i></a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="staff">
                                <div class="staff-img" style="background-image: url(images/mdarhri.jpg);border-radius: 20px;background-position : center;background-size:cover;box-shadow: 0 19px 51px 0 rgba(0,0,0,0.16), 0 14px 19px 0 rgba(0,0,0,0.07);">
                                    <ul class="fh5co-social">
                                        ...
                                        <li><a href="https://www.linkedin.com/in/yahya-mdarhri-alaoui-8309b41a1/"target="_blank "><i class="icon-linkedin2"></i></a></li>
                                    </ul>
                                </div>
  ...
  box-shadow: 0 19px 51px 0 rgba(0,0,0,0.16), 0 14px 19px 0 rgba(0,0,0,0.07);">
                                    <ul class="fh5co-social">
                                        ...
                                        <li><a href="https://www.linkedin.com/in/khadija-arbaoui-037a661bb/"target="_blank "><i class="icon-linkedin2"></i></a></li>
                                    </ul>
                                </div>
  ...
  box-shadow: 0 19px 51px 0 rgba(0,0,0,0.16), 0 14px 19px 0 rgba(0,0,0,0.07);">
                                    <ul class="fh5co-social">
                                        ...
                                        <li><a href="https://www.linkedin.com/in/mohammed-ayoub-el-maftouhi-7b435a157/"target="_blank "><i class="icon-linkedin2"></i></a></li>
                                    </ul>
                                </div>
  ...
  box-shadow: 0 19px 51px 0 rgba(0,0,0,0.16), 0 14px 19px 0 rgba(0,0,0,0.07);">
                                    <ul class="fh5co-social">
                                        ...
                                        <li><a href="https://www.linkedin.com/in/amina-el-kadi-989507192/"target="_blank "><i class="icon-linkedin2"></i></a></li>

                ...
                <div class="container">
                    <div class="row animate-box">
                        <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                            ...
                            <p>Grâce à nos partenaires, l'impossible demeure possible, et l'ampleur des activités se présente devant nous comme un défi à gagner plus qu'une épreuve qui nous effraie.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 animate-box">
                            <div class="course">
                                ...
                                <div class="desc">
                                    <h3><a href="./alensao.php">ALENSAO</a></h3>
                                    ...
                                    <span><a href="./alensao.php" class="btn btn-primary btn-sm btn-course">découvrir ALENSAO</a></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 animate-box">
